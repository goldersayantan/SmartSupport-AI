    ...
    <section className="category-ticket-explorer">
      ...
      <div className="ticket-explorer-header">
        <div>
          ...
          <h3>{selectedFilter ? `${selectedFilter} Tickets` : "Explore Category Tickets"}</h3>
          <p>Select a sentiment or priority toview matching tickets.</p>
        </div>

        {selectedFilter && (

          <button className="clear-category-filter" onClick={() => setSelectedFilter(null)}>
            Clear Filter
          </button>
        )}
      </div>
      ...
      <div className="ticket-filter-group">
        <div className="ticket-filter-heading">
          <h4>Sentiment</h4>
          <span>Customer emotional tone</span>
        </div>
        ...
        <div className="ticket-filter-grid">
          ...
          >
            ...
            <span>Negative</span>
            <strong>{sentimentData[0].count}</strong>
            <small>Tickets</small>
          </div>
          ...
          >
            ...
            <span>Neutral</span>
            <strong>{sentimentData[1].count}</strong>
            <small>Tickets</small>
          </div>
          ...
          >
            ...
            <span>Positive</span>
            <strong>{sentimentData[2].count}</strong>
            <small>Tickets</small>
          </div>
        </div>
      </div>
      ...
      <div className="ticket-filter-group">
        <div className="ticket-filter-heading">
          <h4>Priority</h4>
          <span>Ticket urgency level</span>
        </div>
        ...
        <div className="ticket-filter-grid">
          ...
          >
            ...
            <span>High</span>
            <strong>{priorityData[0].count}</strong>
            <small>Tickets</small>
          </div>
          ...
          >
            ...
            <span>Medium</span>
            <strong>{priorityData[1].count}</strong>
            <small>Tickets</small>
          </div>
          ...
          >
            ...
            <span>Low</span>
            <strong>{priorityData[2].count}</strong>
            <small>Tickets</small>
          </div>
        </div>
      </div>
        ...
        <div className="category-filtered-ticket-list">
          {filteredTickets.map((ticket) => (
            ...
            >
              ...
              <p className="category-ticket-message">{ticket.ticket}</p>
