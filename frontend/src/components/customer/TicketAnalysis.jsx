    ...
    <section className="ticket-analysis">
      ...
      <div className="analysis-grid">
        ...
        <div className="analysis-card">
          ...
          <div className="analysis-card-icon category">
            ◎
          </div>
        ...
        <div className="analysis-card">
          ...
          <div className="analysis-card-icon priority">
            !
          </div>
        ...
        <div className="analysis-card">
          ...
          <div className="analysis-card-icon sentiment">
            ♡
          </div>
        ...
        <div className="analysis-card">
          ...
          <div className="analysis-card-icon time">
            ◷
          </div>
